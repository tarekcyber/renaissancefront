...
/**
 * Vue : Gestion — Classes
 * Gestion des classes / groupes (liste, affectations).
...
<head>
  ...
  <title>Classes - ASBL La Renaissance</title>
...
<body>
    ...
    <div class="main-membre">
      ...
      <div class="content-membre">
        <div class="page-header-classes">
          <div>
            <h1 class="page-title-membre" style="margin: 0 0 4px; color: #000000;">Gestion des classes</h1>
            <p class="page-subtitle-membre">Créez et gérez les classes de l'ASBL</p>
          </div>
          <button type="button" class="btn btn-primary btn-sm classes-btn-create">
            <i class="bi bi-plus-lg" aria-hidden="true"></i>
            <span>Créer une classe</span>
          </button>
        </div>

        <div class="classes-gestion-grid">
          <div class="classe-gestion-card">
            <div class="classe-gestion-card__header">
              <h3 class="classe-gestion-card__title">Classe 1A</h3>
              <div class="classe-gestion-card__actions">
                <button type="button" class="btn btn-outline-primary btn-sm classe-action-btn classe-action-membres" aria-label="Voir les membres">
                  <i class="bi bi-people" aria-hidden="true"></i>
                </button>
                <button type="button" class="btn btn-outline-danger btn-sm classe-action-btn classe-action-delete" aria-label="Supprimer">
                  <i class="bi bi-trash3" aria-hidden="true"></i>
                </button>
              </div>
            </div>
            <div class="classe-gestion-card__fields">
              <div class="classe-field">
                <label class="classe-field__label">Niveau</label>
                <p class="classe-field__value">Primaire 3</p>
              </div>
              <div class="classe-field">
                <label class="classe-field__label">Activité</label>
                <p class="classe-field__value">Cours de Français - Débutant</p>
              </div>
              <div class="classe-field">
                <label class="classe-field__label">Professeur</label>
                <p class="classe-field__value">Pierre Bernard</p>
              </div>
            </div>
          </div>
          ...
          <div class="classe-gestion-card">
            <div class="classe-gestion-card__header">
              <h3 class="classe-gestion-card__title">Classe 2B</h3>
              <div class="classe-gestion-card__actions">
                <button type="button" class="btn btn-outline-primary btn-sm classe-action-btn classe-action-membres" aria-label="Voir les membres">
                  <i class="bi bi-people" aria-hidden="true"></i>
                </button>
            ...
            <div class="classe-gestion-card__fields">
              <div class="classe-field">
                <label class="classe-field__label">Niveau</label>
                <p class="classe-field__value">Primaire 2</p>
              </div>
              <div class="classe-field">
                <label class="classe-field__label">Activité</label>
                <p class="classe-field__value">Soutien Scolaire - Mathématiques</p>
              </div>
              <div class="classe-field">
                <label class="classe-field__label">Professeur</label>
                <p class="classe-field__value">Marie Dubois</p>
              </div>
            </div>
          </div>
        </div>
  ...
  <div id="modal-classe-membres" class="modal" role="dialog" aria-labelledby="modal-classe-membres-title" aria-modal="true" hidden>
    <div class="modal-backdrop"></div>
    <div class="modal-content modal-content--membre">
      <h2 id="modal-classe-membres-title" class="modal-title">Membres de la classe</h2>
      <div class="modal-commentaire-body">
        <ul class="modal-enfants-list" id="modal-classe-membres-list">
          <!-- Liste des membres sera ajoutée dynamiquement -->
        </ul>
      </div>
      <div class="modal-actions">
        <button type="button" class="btn btn-secondary modal-btn-cancel">Fermer</button>
      </div>
    </div>
  </div>

  <div id="modal-supprimer-classe" class="modal" role="dialog" aria-labelledby="modal-supprimer-classe-title" aria-modal="true" hidden>
    <div class="modal-backdrop"></div>
    <div class="modal-content modal-content--inscription">
      <h2 id="modal-supprimer-classe-title" class="modal-title">Supprimer la classe</h2>
      <p class="modal-text">Voulez-vous vraiment supprimer la classe <strong id="modal-supprimer-classe-nom"></strong> ?</p>
      <div class="modal-actions">
        <button type="button" class="btn btn-secondary modal-btn-cancel">Annuler</button>
        <button type="button" class="btn btn-danger modal-btn-confirm">Supprimer</button>
      </div>
    </div>
  </div>

  <div id="modal-creer-classe" class="modal" role="dialog" aria-labelledby="modal-creer-classe-title" aria-modal="true" hidden>
    <div class="modal-backdrop"></div>
    <div class="modal-content modal-content--membre">
      <h2 id="modal-creer-classe-title" class="modal-title">Créer une classe</h2>
      <div class="modal-commentaire-body">
        <form id="form-creer-classe" class="form-creer-classe">
          <div class="form-group">
            <label for="classe-nom" class="form-label">Nom de la classe</label>
            <input type="text" id="classe-nom" class="form-control" name="classe_nom" placeholder="Ex: Classe 1A" required>
          </div>
          <div class="form-group">
            <label for="classe-niveau" class="form-label">Niveau</label>
            <select id="classe-niveau" class="form-control" name="classe_niveau" required>
              ...
              <option value="secondaire-6">Secondaire 6</option>
            </select>
          </div>
          <div class="form-group">
            <label for="classe-activite" class="form-label">Activité</label>
            <select id="classe-activite" class="form-control" name="classe_activite" required>
              <option value="">— Choisir —</option>
              <option value="1">Cours de Français - Débutant</option>
              <option value="2">Soutien Scolaire - Mathématiques</option>
              <option value="3">Cours d'Anglais - Intermédiaire</option>
              <option value="4">Soutien Scolaire - Français</option>
            </select>
          </div>
          <div class="form-group">
            <label for="classe-couleur" class="form-label">Couleur (pastille calendrier)</label>
            <input type="color" id="classe-couleur" class="form-control" name="classe_couleur" value="#15C4AA" required>
          </div>
          <div class="form-group">
            <label for="classe-enseignant" class="form-label">Enseignant</label>
            <select id="classe-enseignant" class="form-control" name="classe_enseignant" required>
              <option value="">— Choisir —</option>
              <option value="1">Pierre Bernard</option>
      ...
      <div class="modal-actions">
        <button type="button" class="btn btn-secondary modal-btn-cancel">Annuler</button>
        <button type="button" class="btn btn-primary modal-btn-confirm" form="form-creer-classe">Créer</button>
      </div>
    </div>
  </div>
