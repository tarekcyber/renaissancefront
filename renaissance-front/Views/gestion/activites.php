<?php
/**
 * Vue : Gestion — Activités
 * Liste / gestion des activités (formulaires, créneaux).
...
<head>
  ...
  <title>Activités - ASBL La Renaissance</title>
  ...
  <div class="layout-membre layout-membre--sidebar-collapsed">
    ...
    <div class="main-membre">
      ...
      <div class="content-membre">
        <div class="page-header-activites">
          <div>
            <h1 class="page-title-membre" style="margin: 0 0 4px; color: #000000;">Gestion des activités</h1>
            <p class="page-subtitle-membre">Créez et gérez les activités proposées par l'ASBL</p>
          </div>
          <button type="button" class="btn btn-primary btn-sm activites-btn-create">
            <i class="bi bi-plus-lg" aria-hidden="true"></i>
            <span>Créer une activité</span>
          </button>
        </div>

        <div class="activites-gestion-grid">
          <div class="activite-gestion-card">
            <div class="activite-gestion-card__header">
              <h3 class="activite-gestion-card__title">Cours de Français - Débutant</h3>
              <div class="activite-gestion-card__actions">
                <button type="button" class="activite-action-btn activite-action-edit" aria-label="Modifier">
                  <i class="bi bi-pencil" aria-hidden="true"></i>
                </button>
                <button type="button" class="activite-action-btn activite-action-delete" aria-label="Supprimer">
                  <i class="bi bi-trash3" aria-hidden="true"></i>
                </button>
              </div>
            </div>
            <span class="badge-categorie badge-categorie--langue">Cours de langue</span>
            <p class="activite-gestion-card__description">Cours de français pour débutants. Apprentissage des bases de la langue.</p>
            <div class="activite-gestion-card__details">
              <div class="activite-detail-item">
                <i class="bi bi-calendar-event activite-detail-icon" aria-hidden="true"></i>
                <span>Lundi, Mercredi</span>
              </div>
              <div class="activite-detail-item">
                <i class="bi bi-clock activite-detail-icon" aria-hidden="true"></i>
                <span>14:00 - 16:00</span>
              </div>
              <div class="activite-detail-item">
                <i class="bi bi-currency-euro activite-detail-icon" aria-hidden="true"></i>
                <span>50€/mois</span>
              </div>
              <div class="activite-detail-item">
                <i class="bi bi-people activite-detail-icon" aria-hidden="true"></i>
                <span>12/15 inscrits</span>
              </div>
            </div>
            <p class="activite-gestion-card__enseignant">Enseignant: Pierre Bernard</p>
          </div>

          <div class="activite-gestion-card">
            <div class="activite-gestion-card__header">
              <h3 class="activite-gestion-card__title">Soutien Scolaire - Mathématiques</h3>
              <div class="activite-gestion-card__actions">
                <button type="button" class="activite-action-btn activite-action-edit" aria-label="Modifier">
                  <i class="bi bi-pencil" aria-hidden="true"></i>
                </button>
            ...
            <span class="badge-categorie badge-categorie--soutien">Soutien scolaire</span>
            <p class="activite-gestion-card__description">Aide aux devoirs et soutien en mathématiques pour primaire et secondaire.</p>
            <div class="activite-gestion-card__details">
              <div class="activite-detail-item">
                <i class="bi bi-calendar-event activite-detail-icon" aria-hidden="true"></i>
            ...
            <p class="activite-gestion-card__enseignant">Enseignant: Julie Moreau</p>
          </div>
        </div>
