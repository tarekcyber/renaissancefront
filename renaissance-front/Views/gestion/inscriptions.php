    ...
    <div class="main-membre">
      ...
      <div class="content-membre">
        ...
        <div class="inscriptions-filters-tabs">
          <button type="button" class="inscriptions-tab inscriptions-tab--active" data-filter="tous">File d'attente</button>
          ...
          <button type="button" class="inscriptions-tab" data-filter="file-attente">Tous</button>
        </div>
