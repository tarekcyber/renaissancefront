...
<body>
      ...
      <div class="content-membre">
        ...
        <div class="formulaires-grid formulaires-grid--trois" id="enseignement-classes-grid">
          <div class="card formulaire-card formulaire-card--clickable enseignement-classe-card" role="button" tabindex="0" data-classe="Français - Débutant">
            ...
            <p class="formulaire-card__info" style="margin: 8px 0 0;">Moyenne d'âge : 11 ans</p>
          </div>
          <div class="card formulaire-card formulaire-card--clickable enseignement-classe-card" role="button" tabindex="0" data-classe="Mathématiques - 1re">
            ...
            <p class="formulaire-card__info" style="margin: 8px 0 0;">Moyenne d'âge : 12 ans</p>
          </div>
          <div class="card formulaire-card formulaire-card--clickable enseignement-classe-card" role="button" tabindex="0" data-classe="Anglais - Intermédiaire">
            ...
            <p class="formulaire-card__info" style="margin: 8px 0 0;">Moyenne d'âge : 13 ans</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="modal-content modal-content--presence">
      ...
      <ul class="presence-list" id="presence-list" aria-label="Liste des élèves">
        <li class="presence-row">
          ...
          <select class="form-control presence-status-select" aria-label="Statut de présence de Emma Dubois">
            <option value="present" selected>Présent</option>
            <option value="retard">Retard</option>
            <option value="parti-tot">Parti tôt</option>
          </select>
        </li>
        <li class="presence-row">
          <span class="presence-nom">Lucas Martin</span>
          <select class="form-control presence-status-select" aria-label="Statut de présence de Lucas Martin">
            <option value="present" selected>Présent</option>
            <option value="retard">Retard</option>
            <option value="parti-tot">Parti tôt</option>
          </select>
        ...
        <li class="presence-row">
          ...
          <select class="form-control presence-status-select" aria-label="Statut de présence de Chloé Bernard">
            <option value="present" selected>Présent</option>
            <option value="retard">Retard</option>
            <option value="parti-tot">Parti tôt</option>
          </select>
        ...
        <li class="presence-row">
          ...
          <select class="form-control presence-status-select" aria-label="Statut de présence de Thomas Petit">
            <option value="present" selected>Présent</option>
            <option value="retard">Retard</option>
            <option value="parti-tot">Parti tôt</option>
          </select>
        ...
        <li class="presence-row">
          ...
          <select class="form-control presence-status-select" aria-label="Statut de présence de Léa Moreau">
            <option value="present" selected>Présent</option>
            <option value="retard">Retard</option>
            <option value="parti-tot">Parti tôt</option>
          </select>
  ...
  <script>
    (function() {
      ...
      var presenceSelects = modal && modal.querySelectorAll('.presence-status-select');
      ...
      function openPresence() {
        ...
        if (presenceSelects) {
          presenceSelects.forEach(function(selectEl) {
