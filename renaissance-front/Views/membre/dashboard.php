<?php
/**
 * Vue : Espace membre — Accueil (dashboard)
 * Résumé, annonces, prochains cours, boutons d’action (inscription, paiements, documents).
 * Layout : sidebar + header membre + zone contenu.
 */
?>
<!DOCTYPE html>
<html lang="fr">
<head>
  ...
  <title>Accueil - ASBL La Renaissance</title>
...
<body>
  <div class="layout-membre layout-membre--sidebar-collapsed">
    <!-- Sidebar : menu nav membre (Accueil, Profil, Gestion, Enseignement, Mes enfants, etc.) -->
    ...
    <!-- Zone principale : header (logo, notifs, profil) + contenu -->
    <div class="main-membre">
      <header class="header-membre">
        <a href="https://ecolelarenaissance.wixsite.com/ecolelarenaissance" target="_blank" rel="noopener noreferrer" class="header-logo" aria-label="Site ASBL La Renaissance (nouvel onglet)">
      ...
      <div class="content-membre">
        <h1 style="margin: 0 0 24px; color: #000000;">Bienvenue Marie !</h1>

        <!-- Cartes : Résumé, Prochains cours, boutons d’action -->
        <div class="card">
          <h2 style="margin: 0 0 16px; font-size: 1.1rem;">Résumé</h2>
          <p class="dashboard-annonce-vide">Aucune annonce</p>
          <p style="margin: 0;"><span class="dashboard-cotisation-badge">Cotisations à payer : 45,00 €</span></p>
        </div>

        <div class="card">
          <h2 style="margin: 0 0 16px; font-size: 1.1rem;">Prochains cours</h2>
          <ul style="list-style: none; padding-left: 0; margin: 0;">
            <li style="padding: 8px 0; border-bottom: 1px solid var(--grisBorder);">Lun. 18/02 — Soutien scolaire — Lucas</li>
            <li style="padding: 8px 0; border-bottom: 1px solid var(--grisBorder);">Mer. 20/02 — Cours de français — Lucas</li>
            <li style="padding: 8px 0;">Ven. 22/02 — Soutien scolaire — Emma</li>
          </ul>
        </div>

        <div style="display: flex; gap: 16px; flex-wrap: wrap; margin-top: 24px;">
          <a href="index.php?page=membre/inscriptions" class="btn btn-primary btn-sm">Nouvelle inscription</a>
          <a href="index.php?page=membre/cotisations" class="btn btn-secondary btn-sm">Voir mes paiements</a>
          <a href="index.php?page=membre/documents" class="btn btn-secondary btn-sm">Uploader un document</a>
        </div>
      </div>
    </div>
  </div>
