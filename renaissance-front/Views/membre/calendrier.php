<?php
/**
 * Vue : Espace membre — Calendrier
 * Liste des prochains cours / événements.
...
<head>
  ...
  <title>Calendrier - ASBL La Renaissance</title>
  <link rel="icon" href="images/favicon.ico">
  <link rel="stylesheet" href="css/style.css?v=20260320-1">
...
<body>
  <div class="layout-membre layout-membre--sidebar-collapsed">
    ...
    <div class="main-membre">
      ...
      <div class="content-membre">
        <h1 style="margin: 0 0 24px; color: #000000;">Calendrier</h1>

        <!-- Carte liste des prochains cours -->
        <div class="card">
          <h2 style="margin: 0 0 16px; font-size: 1.1rem;">Prochains cours</h2>
          <ul style="list-style: none; padding-left: 0; margin: 0;">
            <li style="padding: 8px 0; border-bottom: 1px solid var(--grisBorder);">
              <span class="calendrier-mini-dot" data-calendrier-activite="2" aria-hidden="true" style="display:inline-block;width:10px;height:10px;border-radius:50%;margin-right:12px;background:#8b5cf6;"></span>
              Lun. 18/02 — Soutien scolaire — Lucas
            </li>
            <li style="padding: 8px 0; border-bottom: 1px solid var(--grisBorder);">
              <span class="calendrier-mini-dot" data-calendrier-activite="1" aria-hidden="true" style="display:inline-block;width:10px;height:10px;border-radius:50%;margin-right:12px;background:#2563eb;"></span>
              Mer. 20/02 — Cours de français — Lucas
            </li>
            <li style="padding: 8px 0;">
              <span class="calendrier-mini-dot" data-calendrier-activite="3" aria-hidden="true" style="display:inline-block;width:10px;height:10px;border-radius:50%;margin-right:12px;background:#10b981;"></span>
              Ven. 22/02 — Soutien scolaire — Emma
            </li>
          </ul>
        </div>

        <div class="calendrier-section" id="calendrier-section">
          <div class="calendrier-header">
            <button type="button" class="calendrier-nav calendrier-nav--prev" aria-label="Mois précédent">‹</button>
            <h2 class="calendrier-month-year" id="calendrier-month-year"></h2>
            <button type="button" class="calendrier-nav calendrier-nav--next" aria-label="Mois suivant">›</button>
          </div>
          <div class="calendrier-grid" id="calendrier-grid" role="grid" aria-label="Calendrier"></div>
        </div>
      </div>
    </div>
  </div>
  ...
  <script src="js/script.js?v=20260320-1"></script>
</body>
</html>
