<?php
/**
 * Vue : Espace membre — Mon profil
 * Carte profil (avatar, nom, rôle) + formulaire de modification des infos membre.
...
<head>
  ...
  <title>Mon profil - ASBL La Renaissance</title>
...
<body>
  <div class="layout-membre layout-membre--sidebar-collapsed">
    ...
    <div class="main-membre">
      ...
      <div class="content-membre">
        <h1 class="page-title-membre">Mon profil</h1>

        <!-- Carte profil (photo, nom, rôle) -->
        <div class="card profil-card">
          <header class="profil-header">
            <div class="profil-header__avatar-wrap">
              <img src="images/default-pfp.png" alt="" class="profil-photo" width="96" height="96">
            </div>
            <div class="profil-header__info">
              <h2 class="profil-header__name">Marie Martin</h2>
              <span class="profil-header__meta">PARENT</span>
              <button type="button" class="btn btn-secondary btn-sm profil-header__action">Modifier le profil</button>
            </div>
          </header>

          <section class="profil-section">
            <h3 class="profil-section__title">Informations personnelles</h3>
            <dl class="profil-fields">
              <div class="profil-field">
                <dt class="profil-field__label">Nom</dt>
                <dd class="profil-field__value">Martin</dd>
              </div>
              <div class="profil-field">
                <dt class="profil-field__label">Prénom</dt>
                <dd class="profil-field__value">Marie</dd>
              </div>
              <div class="profil-field">
                <dt class="profil-field__label">Email</dt>
                <dd class="profil-field__value">marie.martin@email.be</dd>
              </div>
              <div class="profil-field">
                <dt class="profil-field__label">Téléphone</dt>
                <dd class="profil-field__value">+32 XXX XX XX XX</dd>
              </div>
              <div class="profil-field">
                <dt class="profil-field__label">Adresse</dt>
                <dd class="profil-field__value">Rue Example 42, 1000 Bruxelles</dd>
              </div>
              <div class="profil-field">
                <dt class="profil-field__label">Date de naissance</dt>
                <dd class="profil-field__value">15/03/1985</dd>
              </div>
              <div class="profil-field">
                <dt class="profil-field__label">Mot de passe</dt>
                <dd class="profil-field__value">••••••••</dd>
              </div>
            </dl>
          </section>

          <section class="profil-section profil-section--last">
            <h3 class="profil-section__title">Préférences</h3>
            <div class="profil-field profil-field--inline">
              <span class="profil-field__label">Autorisation photo</span>
              <span class="profil-badge profil-badge--success">Oui</span>
            </div>
          </section>

          <div class="profil-supprimer-wrap">
            <button type="button" class="btn btn-danger btn-sm" id="btn-supprimer-compte">Supprimer le compte</button>
          </div>
        </div>
      </div>
    </div>
  </div>
  <!-- Modals : suppression de compte et déconnexion -->
  <div id="modal-supprimer-compte" class="modal" role="dialog" aria-labelledby="modal-supprimer-compte-title" aria-modal="true" hidden>
    <div class="modal-backdrop"></div>
    <div class="modal-content modal-content--archiver">
      <h2 id="modal-supprimer-compte-title" class="modal-title">Supprimer le compte</h2>
      <p class="modal-text">Voulez-vous vraiment supprimer votre compte ? Cette action est irréversible et supprimera toutes vos données.</p>
      <div class="modal-actions">
        <button type="button" class="btn btn-secondary modal-btn-cancel">Annuler</button>
        <button type="button" class="btn btn-danger modal-btn-confirm">Supprimer le compte</button>
      </div>
    </div>
  </div>
  ...
  <script>
    (function() {
      var btn = document.getElementById('btn-supprimer-compte');
