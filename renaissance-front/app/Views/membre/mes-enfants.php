<?php
/**
 * Vue : Espace membre — Mes enfants
 * Grille de cartes (un enfant par carte) avec activités et lien « Voir détails ».
...
<head>
  ...
  <title>Mes enfants - ASBL La Renaissance</title>
...
<body>
  <div class="layout-membre layout-membre--sidebar-collapsed">
    ...
    <div class="main-membre">
      ...
      <div class="content-membre content-membre--left">
        <h1 class="page-title-membre">Mes enfants</h1>
        <!-- Grille des cartes enfants (photo, nom, âge, activités, bouton) -->
        <div class="activites-grid activites-grid--left" style="grid-template-columns: repeat(auto-fill, minmax(280px, 1fr));">
          <div class="card" style="display: flex; flex-direction: column; position: relative;">
            <img src="https://via.placeholder.com/80x80" alt="" style="border-radius: 50%; margin-bottom: 8px;">
            <h3 style="margin: 0 0 8px; padding-bottom: 8px; border-bottom: 1px solid var(--grisBorder); color: #000000;">Lucas Bernard — 10 ans</h3>
            <div style="margin: 0 0 12px; display: flex; flex-direction: column; gap: 6px; flex: 1;">
              <span class="enfants-card-activite">Soutien scolaire : P4</span>
              <span class="enfants-card-activite">Cours de français : P4</span>
            </div>
            <div class="enfants-card-actions" style="margin-top: auto; justify-content: flex-end;">
              <a href="#" class="btn btn-secondary btn-sm">Voir détails</a>
            </div>
          </div>
          <div class="card" style="display: flex; flex-direction: column; position: relative;">
            <img src="https://via.placeholder.com/80x80" alt="" style="border-radius: 50%; margin-bottom: 8px;">
            <h3 style="margin: 0 0 8px; padding-bottom: 8px; border-bottom: 1px solid var(--grisBorder); color: #000000;">Emma Bernard — 8 ans</h3>
            <div style="margin: 0 0 12px; display: flex; flex-direction: column; gap: 6px; flex: 1;">
              <span class="enfants-card-activite">Soutien scolaire : P2</span>
            </div>
            <div class="enfants-card-actions" style="margin-top: auto; justify-content: flex-end;">
              <a href="#" class="btn btn-secondary btn-sm">Voir détails</a>
            </div>
        ...
        <p class="mt-2"><a href="#" class="btn btn-primary btn-sm">Ajouter un enfant</a></p>
      </div>
    </div>
  </div>
