<?php
/**
 * Vue : Espace membre — Documents
 * Upload de document (type, fichier) + liste des documents déposés.
...
<head>
  ...
  <title>Documents - ASBL La Renaissance</title>
  ...
  <div class="layout-membre layout-membre--sidebar-collapsed">
    ...
    <div class="main-membre">
      ...
      <div class="content-membre">
        <h1 style="margin: 0 0 24px; color: #000000;">Documents</h1>
        <!-- Carte upload (type de document + fichier) -->
        <div class="card mb-2 documents-upload-card">
          <h2 style="margin: 0 0 16px; font-size: 1.1rem;">Uploader un document</h2>
          <div class="form-group">
            <label>Type de document</label>
            <select>
              <option>Bulletin scolaire</option>
              <option>Certificat médical</option>
              <option>Aménagement raisonnable</option>
              <option>Autorisation photo</option>
              <option>Autre</option>
            </select>
          </div>
          <div class="form-group">
            <label>Enfant concerné (si applicable)</label>
            <select><option>—</option><option>Lucas Bernard</option><option>Emma Bernard</option></select>
          </div>
          <div class="form-group">
            <label>Fichier</label>
        ...
        <div class="card">
          <h2 style="margin: 0 0 16px; font-size: 1.25rem;">Liste des documents</h2>
          <div class="table-wrap">
            <table style="border-radius: 8px; overflow: hidden;">
              <thead style="background-color: #dcf6f2;">
                <tr><th style="color: var(--bleuFonce);">Type</th><th style="color: var(--bleuFonce);">Date</th><th style="color: var(--bleuFonce);">Fichier</th></tr>
              </thead>
              <tbody>
                <tr><td>Bulletin</td><td>15/01/2025</td><td><a href="#">bulletin_p4.pdf</a></td></tr>
              </tbody>
            </table>
          </div>
        </div>
