<?php
/**
 * Vue : Gestion — Paiements
 * Suivi des paiements / cotisations (tableau, statuts).
...
<head>
  ...
  <title>Paiements - ASBL La Renaissance</title>
...
<body>
  <div class="layout-membre layout-membre--sidebar-collapsed">
    ...
    <div class="main-membre">
      ...
      <div class="content-membre">
        <div class="page-header-paiements">
          <div>
            <h1 class="page-title-membre" style="margin: 0 0 4px; color: #000000;">Gestion des paiements</h1>
            <p class="page-subtitle-membre">Suivez les paiements et envoyez des rappels</p>
          </div>
        </div>

        <div class="paiements-stats-grid">
          <div class="paiements-stat-card">
            <p class="paiements-stat-label">Total attendu</p>
            <p class="paiements-stat-value paiements-stat-value--total">210€</p>
          </div>
          <div class="paiements-stat-card">
            <p class="paiements-stat-label">Payés</p>
            <p class="paiements-stat-value paiements-stat-value--payes">1</p>
          </div>
          <div class="paiements-stat-card">
            <p class="paiements-stat-label">En attente</p>
            <p class="paiements-stat-value paiements-stat-value--attente">2</p>
          </div>
          <div class="paiements-stat-card">
            <p class="paiements-stat-label">En retard</p>
            <p class="paiements-stat-value paiements-stat-value--retard">1</p>
          </div>
        </div>

        <div class="paiements-filters">
          <div class="paiements-search">
            <i class="bi bi-search paiements-search__icon" aria-hidden="true"></i>
            <input type="search" class="paiements-search__input" placeholder="Rechercher un membre…">
          </div>
          <div class="paiements-filters-tabs">
            <button type="button" class="paiements-tab paiements-tab--active" data-filter="tous">Tous</button>
            <button type="button" class="paiements-tab" data-filter="attente">En attente</button>
            <button type="button" class="paiements-tab" data-filter="retard">En retard</button>
          </div>
        </div>

        <div class="card-paiement card-paiement--table">
          <div class="table-wrap">
            <div class="table-header-actions">
              <table class="table-paiements" aria-label="Liste des paiements">
                <thead>
                  <tr>
                    <th scope="col" style="width: 40px;">
                      <input type="checkbox" aria-label="Sélectionner tout">
                    </th>
              ...
              <tbody>
                <tr data-statut="paye">
                  <td>
                    <input type="checkbox" aria-label="Sélectionner Jean Dupont">
                  </td>
                  <td>
                    <div class="paiement-membre">
                      <strong class="paiement-membre__nom">Jean Dupont</strong>
                      <span class="paiement-membre__email">jean.dupont@email.com</span>
                    </div>
                  </td>
                  <td>Mars 2026</td>
                  <td>31/03/2026</td>
                  <td>15/03/2026</td>
                  <td>
                    <span class="badge-paiement badge-paiement--paye">Payé</span>
                  </td>
                  <td><strong>50€</strong></td>
                  <td>
                    <div class="paiement-actions">
                      <!-- Aucune action pour les paiements payés -->
                    </div>
                  </td>
                </tr>
                <tr data-statut="attente">
                  <td>
                    <input type="checkbox" aria-label="Sélectionner Claire Martin">
                  </td>
                  <td>
                    <div class="paiement-membre">
                      <strong class="paiement-membre__nom">Claire Martin</strong>
                      <span class="paiement-membre__email">claire.martin@email.com</span>
                    </div>
                  </td>
                  <td>Mars 2026</td>
                  <td>31/03/2026</td>
                  <td>-</td>
                  <td>
                    <span class="badge-paiement badge-paiement--attente">En attente</span>
                  </td>
                  <td><strong>60€</strong></td>
                  <td>
                    <div class="paiement-actions">
                      <button type="button" class="paiement-action-link paiement-action-rappel" aria-label="Envoyer un rappel">
                        <i class="bi bi-envelope" aria-hidden="true"></i>
                        <span>Rappel</span>
                      </button>
                      <button type="button" class="paiement-action-link paiement-action-marquer" aria-label="Marquer comme payé">
                ...
                <tr data-statut="retard">
                  <td>
                    <input type="checkbox" aria-label="Sélectionner Sophie Dubois">
                  </td>
                  <td>
                    <div class="paiement-membre">
                      <strong class="paiement-membre__nom">Sophie Dubois</strong>
                      <span class="paiement-membre__email">sophie.dubois@email.com</span>
                    </div>
                  </td>
                  <td>Mars 2026</td>
                  <td>28/02/2026</td>
                  <td>-</td>
                  <td>
                    <span class="badge-paiement badge-paiement--retard">En retard</span>
                  </td>
                  <td><strong>50€</strong></td>
                  <td>
                    <div class="paiement-actions">
                ...
                <tr data-statut="attente">
                  <td>
                    <input type="checkbox" aria-label="Sélectionner Thomas Leroy">
                  </td>
                  <td>
                    <div class="paiement-membre">
                      <strong class="paiement-membre__nom">Thomas Leroy</strong>
                      <span class="paiement-membre__email">thomas.leroy@email.com</span>
                    </div>
                  </td>
                  <td>Mars 2026</td>
                  <td>31/03/2026</td>
              ...
              <div class="table-header-archive">
                <button type="button" class="btn btn-outline-primary btn-sm paiement-archive-btn" id="btn-archiver-paiements" aria-label="Archiver les paiements sélectionnés">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-archive" viewBox="0 0 16 16" aria-hidden="true">
  ...
  <div id="modal-archiver-paiements" class="modal" role="dialog" aria-labelledby="modal-archiver-title" aria-modal="true" hidden>
    <div class="modal-backdrop"></div>
    <div class="modal-content modal-content--archiver">
      <h2 id="modal-archiver-title" class="modal-title">Archiver les paiements</h2>
      <p class="modal-text">Voulez-vous archiver les paiements sélectionnés ?</p>
      <div class="modal-actions">
        <button type="button" class="btn btn-secondary modal-btn-cancel">Annuler</button>
        <button type="button" class="btn btn-primary modal-btn-confirm">Archiver</button>
      </div>
    </div>
  </div>
