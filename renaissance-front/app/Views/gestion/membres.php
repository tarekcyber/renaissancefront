...
/**
 * Vue : Gestion — Membres
 * Liste / gestion des membres (tableau, actions admin).
...
<head>
  ...
  <title>Membres - ASBL La Renaissance</title>
...
<body>
  <div class="layout-membre layout-membre--sidebar-collapsed">
        ...
        <ul>
          ...
          <li class="sidebar-submenu-parent">
            ...
            <ul class="sidebar-submenu">
              ...
              <li><a href="index.php?page=gestion/membres" class="active"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="sidebar-icon bi bi-people-fill" viewBox="0 0 16 16" aria-hidden="true"><path d="M7 14s-1 0-1-1 1-4 5-4 5 3 5 4-1 1-1 1zm4-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6m-5.784 6A2.24 2.24 0 0 1 5 13c0-1.355.68-2.75 1.936-3.666A6.5 6.5 0 0 0 8 9c4 0 5 3 5 4 0 .667-.333 1-1 1zM4.5 8a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5"/></svg> <span class="sidebar-nav-label">Membres</span></a></li>
              <li><a href="index.php?page=gestion/inscriptions"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="sidebar-icon bi bi-clipboard-check" viewBox="0 0 16 16" aria-hidden="true"><path fill-rule="evenodd" d="M10.854 7.146a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708 0l-1.5-1.5a.5.5 0 1 1 .708-.708L7.5 9.793l2.646-2.647a.5.5 0 0 1 .708 0"/><path d="M4 1.5H3a2 2 0 0 0-2 2V14a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V3.5a2 2 0 0 0-2-2h-1v1h1a1 1 0 0 1 1 1V14a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V3.5a1 1 0 0 1 1-1h1z"/><path d="M9.5 1a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5v-1a.5.5 0 0 1 .5-.5zm-3-1A1.5 1.5 0 0 0 5 1.5v1A1.5 1.5 0 0 0 6.5 4h3A1.5 1.5 0 0 0 11 2.5v-1A1.5 1.5 0 0 0 9.5 0z"/></svg> <span class="sidebar-nav-label">Inscriptions</span></a></li>
              <li><a href="index.php?page=gestion/activites"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="sidebar-icon bi bi-activity" viewBox="0 0 16 16" aria-hidden="true"><path fill-rule="evenodd" d="M6 2a.5.5 0 0 1 .47.33l4 12a.5.5 0 0 1-.94.28L8 10.54l-3.53 3.07A.5.5 0 0 1 3.5 14a.5.5 0 0 1-.47-.33l-4-12a.5.5 0 0 1 .94-.28L5 9.46l3.53-3.07A.5.5 0 0 1 8.5 6.5z"/></svg> <span class="sidebar-nav-label">Activités</span></a></li>
    ...
    <div class="main-membre">
      ...
      <div class="content-membre">
        <div class="page-header-membres">
          <div>
            <h1 class="page-title-membre">Liste des membres</h1>
            <p class="page-subtitle-membre">Gérez tous les membres de l'ASBL.</p>
          </div>
          <button type="button" class="btn btn-primary btn-sm page-header-membres__export">
        ...
        <div class="membres-filters">
          <div class="membres-search">
            <i class="bi bi-search membres-search__icon" aria-hidden="true"></i>
            <input type="search" class="membres-search__input" placeholder="Rechercher un membre…">
          </div>
          <button type="button" class="btn btn-outline-secondary btn-sm membres-filter-roles">
            <i class="bi bi-funnel" aria-hidden="true"></i>
            <span>Tous les rôles</span>
          </button>
        </div>

        <div class="membres-stats-grid">
          <div class="membres-stat-card">
            <p class="membres-stat-label">Total membres</p>
            <p class="membres-stat-value membres-stat-value--total">6</p>
          </div>
          <div class="membres-stat-card">
            <p class="membres-stat-label">Membres actifs</p>
            <p class="membres-stat-value membres-stat-value--actifs">3</p>
          </div>
          <div class="membres-stat-card">
            <p class="membres-stat-label">Nombre élèves</p>
            <p class="membres-stat-value membres-stat-value--enfants">5</p>
          </div>
          <div class="membres-stat-card">
            <p class="membres-stat-label">Enseignants</p>
            <p class="membres-stat-value membres-stat-value--enseignants">2</p>
          </div>
          <div class="membres-stat-card">
            <p class="membres-stat-label">Administrateurs</p>
            <p class="membres-stat-value membres-stat-value--admins">1</p>
          </div>
          <div class="membres-stat-card">
            <p class="membres-stat-label">Gestionnaires</p>
            <p class="membres-stat-value membres-stat-value--gestionnaires">0</p>
          </div>
        </div>

        <div class="card-membre card-membre--table">
          <div class="table-wrap">
            <table class="table-membres" aria-label="Liste des membres">
              <thead>
                <tr>
                  <th scope="col">Nom</th>
              ...
              <tbody>
                <tr>
                  <td>
                    <div class="membre-identite">
                      <img src="images/default-pfp.png" alt="Jean Dupont" class="membre-avatar">
                      <div class="membre-identite-text">
                        <span class="membre-nom">Jean Dupont</span>
                        <span class="membre-email-secondaire">jean.dupont@email.com</span>
                      </div>
                    </div>
                  </td>
                  <td>jean.dupont@email.com</td>
                  <td>+32 123 45 67 89</td>
                  <td>
                    <div class="membre-role">
                      <select class="membre-role-select" aria-label="Rôle de Jean Dupont">
                  ...
                  <td>
                    <div class="membre-actions">
                      <button type="button" class="btn btn-outline-primary btn-sm membre-action-btn membre-action-commentaire" data-membre-nom="Jean Dupont" aria-label="Ajouter un commentaire sur le membre">
                        <i class="bi bi-chat-dots" aria-hidden="true"></i>
                      </button>
                      <button type="button" class="btn btn-outline-secondary btn-sm membre-action-btn membre-action-enfants" data-membre-nom="Jean Dupont" data-membre-enfants="Lucas Dupont (8 ans)|Emma Dupont (5 ans)" aria-label="Voir les enfants du membre">
                ...
                <tr>
                  <td>
                    <div class="membre-identite">
                      <img src="images/default-pfp.png" alt="Marie Martin" class="membre-avatar">
                      <div class="membre-identite-text">
                        <span class="membre-nom">Marie Martin</span>
                        <span class="membre-email-secondaire">marie.martin@email.com</span>
                      </div>
                    </div>
                  </td>
                  <td>marie.martin@email.com</td>
                  <td>+32 987 65 43 21</td>
                  <td>
                    <div class="membre-role">
                      <select class="membre-role-select" aria-label="Rôle de Marie Martin">
                  ...
                  <td>
                    <div class="membre-actions">
                      <button type="button" class="btn btn-outline-primary btn-sm membre-action-btn membre-action-commentaire" data-membre-nom="Marie Martin" aria-label="Ajouter un commentaire sur le membre">
                        <i class="bi bi-chat-dots" aria-hidden="true"></i>
                      </button>
                      <button type="button" class="btn btn-outline-secondary btn-sm membre-action-btn membre-action-enfants" data-membre-nom="Marie Martin" data-membre-enfants="-" aria-label="Voir les enfants du membre">
                        <i class="bi bi-people" aria-hidden="true"></i>
                      </button>
                    </div>
                  </td>
  ...
  <div id="modal-commentaire-membre" class="modal" role="dialog" aria-labelledby="modal-commentaire-title" aria-modal="true" hidden>
    <div class="modal-backdrop"></div>
    <div class="modal-content modal-content--membre">
      <h2 id="modal-commentaire-title" class="modal-title">Commentaire pour</h2>
      <div class="modal-commentaire-body">
        <textarea class="modal-commentaire-textarea" placeholder="Ajouter un commentaire sur ce membre"></textarea>
      </div>
      <div class="modal-actions">
        <button type="button" class="btn btn-primary modal-commentaire-save">Enregistrer</button>
        <button type="button" class="btn btn-secondary modal-commentaire-cancel">Annuler</button>
      </div>
    </div>
  </div>

  <div id="modal-enfants-membre" class="modal" role="dialog" aria-labelledby="modal-enfants-title" aria-modal="true" hidden>
    <div class="modal-backdrop"></div>
    <div class="modal-content modal-content--membre">
      <h2 id="modal-enfants-title" class="modal-title">Enfants de</h2>
      <ul class="modal-enfants-list">
        <li>Aucun enfant renseigné.</li>
      </ul>
      <div class="modal-actions">
        <button type="button" class="btn btn-secondary modal-enfants-close">Fermer</button>
      </div>
    </div>
  </div>
