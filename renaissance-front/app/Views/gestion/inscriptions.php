<?php
/**
 * Vue : Gestion — Inscriptions
 * Suivi des inscriptions (liste, statuts, validation).
...
<head>
  ...
  <title>Inscriptions - ASBL La Renaissance</title>
...
<body>
  <div class="layout-membre layout-membre--sidebar-collapsed">
    ...
    <div class="main-membre">
      ...
      <div class="content-membre">
        <div class="page-header-inscriptions">
          <div>
            <h1 class="page-title-membre" style="margin: 0 0 4px; color: #000000;">Gestion des inscriptions</h1>
            <p class="page-subtitle-membre">Acceptez, refusez ou gérez les inscriptions</p>
          </div>
        </div>

        <div class="inscriptions-stats-grid">
          <div class="inscriptions-stat-card">
            <p class="inscriptions-stat-label">En attente</p>
            <p class="inscriptions-stat-value inscriptions-stat-value--attente">2</p>
          </div>
          <div class="inscriptions-stat-card">
            <p class="inscriptions-stat-label">Acceptées</p>
            <p class="inscriptions-stat-value inscriptions-stat-value--acceptees">1</p>
          </div>
          <div class="inscriptions-stat-card">
            <p class="inscriptions-stat-label">Refusées</p>
            <p class="inscriptions-stat-value inscriptions-stat-value--refusees">0</p>
          </div>
        </div>

        <div class="inscriptions-filters-tabs">
          <button type="button" class="inscriptions-tab inscriptions-tab--active" data-filter="tous">Tous</button>
          <button type="button" class="inscriptions-tab" data-filter="acceptees">Acceptées</button>
          <button type="button" class="inscriptions-tab" data-filter="refusees">Refusées</button>
          <button type="button" class="inscriptions-tab" data-filter="file-attente">File d'attente</button>
        </div>

        <div class="inscriptions-list">
          <div class="inscription-card" data-statut="attente">
            <div class="inscription-card__content">
              <div class="inscription-card__info">
                <div class="inscription-card__header">
                  <i class="bi bi-person inscription-card__icon" aria-hidden="true"></i>
                  <h3 class="inscription-card__eleve">Sophie Dupont</h3>
                </div>
                <p class="inscription-card__parent">Parent: Jean Dupont</p>
                <div class="inscription-card__cours">
                  <i class="bi bi-calendar-event inscription-card__icon" aria-hidden="true"></i>
                  <span>Cours Langue - Débutant</span>
                </div>
                <p class="inscription-card__dates">Inscrit le 15/02/2026 - Début: 01/03/2026</p>
              </div>
              <div class="inscription-card__actions">
                <span class="badge-statut badge-statut--attente">En attente</span>
                <div class="inscription-card__buttons">
                  <button type="button" class="btn btn-success btn-sm inscription-action-btn inscription-action-accepter" data-inscription-id="1" data-inscription-eleve="Sophie Dupont" aria-label="Accepter">
                    <i class="bi bi-check-lg" aria-hidden="true"></i>
                  </button>
                  <button type="button" class="btn btn-danger btn-sm inscription-action-btn inscription-action-refuser" data-inscription-id="1" data-inscription-eleve="Sophie Dupont" aria-label="Refuser">
                    <i class="bi bi-x-lg" aria-hidden="true"></i>
                  </button>
                  <button type="button" class="btn btn-primary btn-sm inscription-action-btn" aria-label="Mettre en file d'attente">
  ...
  <div id="modal-accepter-inscription" class="modal" role="dialog" aria-labelledby="modal-accepter-title" aria-modal="true" hidden>
    <div class="modal-backdrop"></div>
    <div class="modal-content modal-content--inscription">
      <h2 id="modal-accepter-title" class="modal-title">Accepter l'inscription</h2>
      <p class="modal-text">Voulez-vous accepter l'inscription de <strong id="modal-accepter-eleve"></strong> ?</p>
      <div class="modal-actions">
        <button type="button" class="btn btn-secondary modal-btn-cancel">Annuler</button>
        <button type="button" class="btn btn-success modal-btn-confirm">Accepter</button>
      </div>
    </div>
  </div>

  <div id="modal-refuser-inscription" class="modal" role="dialog" aria-labelledby="modal-refuser-title" aria-modal="true" hidden>
    <div class="modal-backdrop"></div>
    <div class="modal-content modal-content--inscription">
      <h2 id="modal-refuser-title" class="modal-title">Refuser l'inscription</h2>
      <p class="modal-text">Voulez-vous refuser l'inscription de <strong id="modal-refuser-eleve"></strong> ?</p>
      <div class="modal-actions">
        <button type="button" class="btn btn-secondary modal-btn-cancel">Annuler</button>
        <button type="button" class="btn btn-danger modal-btn-confirm">Refuser</button>
      </div>
    </div>
  </div>
